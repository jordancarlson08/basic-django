"""
Django settings for jcarlso2 project.
...
SECRET_KEY = 'ly26uu2as=mscz#o8ngo+q7@u2^d89)war3es*e*1(&u^v*+87'
...
ROOT_URLCONF = 'jcarlso2.urls'

WSGI_APPLICATION = 'jcarlso2.wsgi.application'
